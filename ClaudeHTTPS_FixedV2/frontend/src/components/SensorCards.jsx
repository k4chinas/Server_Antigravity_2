...
export default function SensorCards({ data }) {
  const cards = [
    // Hız kartını en başa, 1. sıraya ekledik
    { icon: "🏎️", label: "Hız", value: data?.Hiz, unit: "km/h", color: "#ff0054" },
  ...
  return (
    <div className="glass-card p-4" id="sensor-cards">
      ...
      {/* Mobilde 2, tablette 5, masaüstünde 10 sütun olacak şekilde tasarımı uyarladık */}
